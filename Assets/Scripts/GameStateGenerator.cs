...
public class EnemyGenerator
{
    ...
    { // Buscar forma de almacenar todos los valores por defecto.
        ...
        List<int> randomList = randomNumberList(numEnemies, listaEnemigos.Length).ToList();
        ...
        List<MovableEntity.ENTITIES_TYPE> enemiesType = randomList.Select(p => listaEnemigos[p]).ToList();
...
public class GameStateGenerator
{
    ...
    public GameState generateNewGameState(int numEnemies, int numHabs, GameState gameState = null) // Mejorar esto
    {
        generateMap(numHabs);
